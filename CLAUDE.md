...
## Quick reference
- Config (живой, на popstas-pc): `C:\Users\popstas\AppData\Roaming\windows-mqtt\windows11-manager.config.js` — первый путь в `resolveConfigPath()`; `~/.config/windows11-manager.config.js` там не существует
