...
const CLAUDE_WT_DEFAULTS = {
  ...
  interval: 1000,
  stableTicks: 2,
  // Пауза между появлением окна новой сессии и фокусом на нём. Ноль — ждать
  // нечего: к моменту, когда окно нашлось по заголовку, терминал нарисован, а
  // место и фокус выдаются здесь же. Ручка оставлена на случай, если терминал
  // на чьей-то машине переставляет себя после запуска. Подробности — у
  // PLACEMENT_SETTLE_MS в project.js.
  focusSettleMs: 0,
  sessionsFile: '',
  statePath: '',
