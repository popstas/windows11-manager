...
const CLAUDE_WT_DEFAULTS = {
  ...
  interval: 1000,
  stableTicks: 2,
  // Пауза между появлением окна новой сессии и фокусом на нём — сколько ждать,
  // пока терминал отрисуется. Настройкой, а не константой в коде: цена ошибки в
  // меньшую сторону — отобранный у человека фокус, и подбирать её приходится на
  // живой машине, где и терминал, и сеть свои. Подробности — у
